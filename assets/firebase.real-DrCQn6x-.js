import{r as Se,_ as Zt,e as en,d as T,g as B,q as Y,E as Oe,f as tn,h as nn,L as sn,j as ft,S as Q,k as rn,F as Le,l as an,i as pt,m as on,n as cn,c as Je,C as Xe,o as g,s as un,t as ln,u as dn,v as hn}from"./index.esm-B9iOFmxY.js";import{setDoc as m,doc as d,deleteDoc as Me,getDoc as _,onSnapshot as y,initializeFirestore as fn,persistentLocalCache as pn,CACHE_SIZE_UNLIMITED as gn,persistentMultipleTabManager as mn,getFirestore as _n,writeBatch as Z,updateDoc as Ue,serverTimestamp as I,collection as me,getDocs as gt}from"./index.esm-C7w9jBNT.js";var In="firebase",wn="12.16.0";/**
 * @license
 ...
 */Se(In,wn,"app");function mt(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const yn=mt,_t=new Oe("auth","Firebase",mt());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ke(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function vn(){return Ye()==="http:"||Ye()==="https:"}function Ye(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ps(n,e,t){return Cs(n,e,t)}async function Cs(n,e,t){if(T(n.app))return Promise.reject(D(n));const s=te(n);It(n,e,_e),await s._initializationPromise;const r=Ge(s,t);return await As(r,s),r._openRedirect(s,e,"signInViaRedirect")}async function Ns(n,e){return await te(n)._initializationPromise,zt(n,e,!1)}async function zt(n,e,t=!1){if(T(n.app))return Promise.reject(D(n));const s=te(n),r=Ge(s,e),a=await new ks(s,r,t).execute();return a&&!t&&(delete a.user._redirectEventId,await s._persistUserIfCurrent(a.user),await s._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ee="webStorageSupport";class or{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=as,this._completeRedirectFn=zt,this._overrideRedirectResult=bs}async _openPopup(e,t,s,r){var a;N((a=this.eventManagers[e._key()])==null?void 0:a.manager,"_initialize() not called before _openPopup()");const i=await ut(e,t,s,ke(),r);return tr(e,i,Be())}async _openRedirect(e,t,s,r){await this._originValidation(e);const i=await ut(e,t,s,ke(),r);return us(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:r,promise:i}=this.eventManagers[t];return r?Promise.resolve(r):(N(i,"If manager is not set, promise should be"),i)}const s=this.initAndGetManager(e);return this.eventManagers[t]={promise:s},s.catch(()=>{delete this.eventManagers[t]}),s}async initAndGetManager(e){const t=await Js(e),s=new Ls(e);return t.register("authEvent",r=>(l(r==null?void 0:r.authEvent,e,"invalid-auth-event"),{status:s.onEvent(r.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=t,s}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Ee,{type:Ee},r=>{var a;const i=(a=r==null?void 0:r[0])==null?void 0:a[Ee];i!==void 0&&t(!!i),R(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Fs(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Nt()||kt()||He()}}const cr=or;var lt="@firebase/auth",dt="1.13.3";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hr=5*60;cn("authIdTokenMaxAge");function fr(){var n;return((n=document.getElementsByTagName("head"))==null?void 0:n[0])??document}jn({loadJS(n){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",n),s.onload=e,s.onerror=r=>{const i=E("internal-error");i.customData=r,t(i)},s.type="text/javascript",s.charset="UTF-8",fr().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});dr("Browser");const pr={apiKey:"AIzaSyB8QE3JylXkXWmg_rF2ZuczixnRYJZlRnE",authDomain:"airmore-task-management-app.firebaseapp.com",projectId:"airmore-task-management-app",storageBucket:"airmore-task-management-app.firebasestorage.app",messagingSenderId:"674161520247",appId:"1:674161520247:web:fe0e0f9d0656008fbaa072",measurementId:"G-VFS9X3L72E"},Ae=hn(pr),J=Jn(Ae,{persistence:[Is,is],popupRedirectResolver:cr}),h=(()=>{try{return fn(Ae,{localCache:pn({tabManager:mn(),cacheSizeBytes:gn})})}catch(n){return console.warn("Firestore永続キャッシュの初期化に失敗。キャッシュ無しで継続します:",n&&n.message),_n(Ae)}})();function Rr(n){return ts(J,n)}async function Ar(){const n=new A;n.setCustomParameters({prompt:"select_account"});try{return(await Es(J,n)).user}catch(e){const t=e&&e.code||"";if(t==="auth/popup-blocked"||t==="auth/cancelled-popup-request"||t==="auth/popup-closed-by-user"||t==="auth/operation-not-supported-in-this-environment")return await Ps(J,n),null;throw e}}async function br(){try{const n=await Ns(J);return(n==null?void 0:n.user)||null}catch(n){return console.warn("redirect result:",n),null}}async function Pr(){await ns(J)}const C={ADMIN:"admin",EDITOR:"editor",VIEWER:"viewer"};function Cr(n){return n===C.ADMIN||n===C.EDITOR||n===C.VIEWER}function Nr(n){return n===C.ADMIN||n===C.EDITOR}function Or(n){return n===C.ADMIN}function Lr(){try{const e=new URL(window.location.href).searchParams.get("ws");if(e)return localStorage.setItem("hittatsu_current_ws",e),e}catch{}return localStorage.getItem("hittatsu_current_ws")||null}async function Mr(n){if(!n)return null;const e=await _(d(h,"workspaces",n));return e.exists()?{id:e.id,...e.data()}:null}function Ur(n,e){return!n||!e?null:(n.budgetRoles||{})[e]||null}function gr(n,e){if(!n||!e)return!1;const t=(n.authMembers||[]).find(s=>s&&s.email===e);return t&&t.role==="owner"}async function Dr(n,e,t){if(!n||!e||!t)return null;const s=(t.budgetRoles||{})[e];if(s)return s;const r=gr(t,e)?C.ADMIN:C.VIEWER;try{const i={...t.budgetRoles||{},[e]:r};return await Ue(d(h,"workspaces",n),{budgetRoles:i}),r}catch(i){return console.warn("ensureRoleAtFirstAccess failed:",i),null}}async function xr(n,e,t){if(!n||!e)return!1;const s=await _(d(h,"workspaces",n));if(!s.exists())return!1;const i={...s.data().userCompanies||{}};return t?i[e]=t:delete i[e],await Ue(d(h,"workspaces",n),{userCompanies:i}),!0}async function Fr(n){if(!n)return[];try{const e=await _(d(h,"workspaces",n,"budget","airmore-budget-v4"));if(!e.exists())return[];const t=e.data()||{};let s=null;try{s=JSON.parse(t.value||"{}")}catch{s={}}return Array.isArray(s.orgs)?s.orgs.map(r=>r.name).filter(Boolean):[]}catch(e){return console.warn("getBudgetOrgs failed:",e),[]}}async function Vr(n,e,t){if(!n||!e)return!1;const s=await _(d(h,"workspaces",n));if(!s.exists())return!1;const i={...s.data().budgetRoles||{}};return t?i[e]=t:delete i[e],await Ue(d(h,"workspaces",n),{budgetRoles:i}),!0}function Wr(n,e){return y(d(h,"workspaces",n),t=>{t.exists()?e({id:t.id,...t.data()}):e(null)})}const mr=n=>me(h,"workspaces",n,"budget");async function Hr(n,e){const t=await _(d(h,"workspaces",n,"budget",ze(e)));return t.exists()?(t.data()||{}).value??null:null}async function qr(n,e,t){await m(d(h,"workspaces",n,"budget",ze(e)),{key:e,value:t,updatedAt:I()})}async function Br(n,e){await Me(d(h,"workspaces",n,"budget",ze(e)))}function Gr(n,e){return y(mr(n),t=>{const s={};t.forEach(r=>{const i=r.data();s[i.key||r.id]=i.value}),e(s)})}function ze(n){return String(n).replace(/[/.#$\[\]]/g,"_").slice(0,250)}const Kt=new Set(["sarazawa@n-airmore.com"]);function jr(n){return!!n&&Kt.has(n)}function zr(n,e){return n?Kt.has(n)?C.ADMIN:(e||{})[n]||null:null}const be=()=>d(h,"globalBudget","roles"),ye=()=>d(h,"globalBudget","data"),Pe=()=>d(h,"globalBudget","userCompanies"),Jt=()=>d(h,"globalBudget","menuConfig"),Ce=()=>d(h,"globalBudget","userRoles"),Ne=()=>d(h,"globalBudget","users");function $r(n,e){return y(be(),t=>{n(t.exists()?t.data().roles||{}:{})},e)}async function _r(n,e){const t=await _(be()),r={...t.exists()?t.data().roles||{}:{}};e?r[n]=e:delete r[n],await m(be(),{roles:r,updatedAt:I()})}function Kr(n,e){return y(ye(),n,e)}async function Jr(){const n=await _(ye());return n.exists()?n.data():null}async function Xr(n,e){await m(ye(),{value:n,updatedAt:I(),_writer:e})}function Yr(n,e){return y(Ce(),t=>{n(t.exists()?t.data().map||{}:{})},e)}async function Qr(n,e){const t=await _(Ce()),r={...t.exists()?t.data().map||{}:{}};e?r[String(n).toLowerCase()]=e:delete r[String(n).toLowerCase()],await m(Ce(),{map:r,updatedAt:I()})}function Zr(n,e){return y(Pe(),t=>{n(t.exists()?t.data().map||{}:{})},e)}function ei(n,e){return y(Jt(),t=>{n(t.exists()?t.data().map||{}:{})},e)}async function ti(n,e){const t=String(n||"").toLowerCase();if(!t)return;const s=await _(Ne()),r=s.exists()?s.data().map||{}:{},i=r[t];i&&i.name===(e||"")||await m(Ne(),{map:{...r,[t]:{email:n,name:e||"",at:new Date().toISOString()}},updatedAt:I()},{merge:!0})}async function ni(){const n=await _(Ne());return n.exists()?n.data().map||{}:{}}async function si(n){await m(Jt(),{map:n,updatedAt:I()})}const Xt=n=>d(h,"salesWs",n),k=(n,e)=>me(h,"salesWs",n,e);function ri(n,e,t){return y(Xt(n),s=>e(s.exists()?s.data():null),t)}async function ii(n,e){await m(Xt(n),{...e,updatedAt:I()},{merge:!0})}function ai(n,e,t,s){return y(k(n,e),r=>t(r.docs.map(i=>i.data())),s)}async function oi(n,e,t,s){const r=[...t.map(i=>({kind:"set",it:i})),...(s||[]).map(i=>({kind:"del",id:i}))];for(let i=0;i<r.length;i+=400){const a=Z(h);for(const c of r.slice(i,i+400))c.kind==="set"?a.set(d(k(n,e),c.it.id),c.it):a.delete(d(k(n,e),c.id));await a.commit()}}async function ci(n,e){await m(d(k(n,"attachments"),e.id),e)}async function ui(n,e,t,s){const r=Z(h);for(const i of t)r.set(d(k(n,"attachments"),i.id),i);r.set(d(k(n,"attachments"),e.id),e);for(let i=t.length;i<(s||0);i++)r.delete(d(k(n,"attachments"),`${e.id}#${i}`));await r.commit()}async function li(n,e,t){if(t>0){const s=Z(h);s.delete(d(k(n,"attachments"),e));for(let r=0;r<t;r++)s.delete(d(k(n,"attachments"),`${e}#${r}`));await s.commit();return}await Me(d(k(n,"attachments"),e))}const $e=n=>d(h,"salesMasters",n),$=n=>me(h,"salesWs",n,"masters"),Ir=8e5,ht=25e4,wr=n=>new TextEncoder().encode(n).length,yr=n=>/exceeds the maximum allowed size|too large|INVALID_ARGUMENT/i.test(String((n==null?void 0:n.message)||n)),X=new Set;function Tr(n){const e=n.find(s=>s._id==="head");if(!e||!e.of)return null;const t=n.filter(s=>s.part!=null&&s.rev===e.rev).sort((s,r)=>s.part-r.part);if(t.length!==e.of||t.some((s,r)=>s.part!==r))return null;try{return JSON.parse(t.map(s=>s.data).join(""))}catch{return null}}function di(n,e,t){let s,r;const i=()=>{s===void 0||r===void 0||e(r||s)},a=y($e(n),o=>{s=o.exists()?o.data():null,i()},t),c=y($(n),o=>{const u=o.docs.map(f=>({_id:f.id,...f.data()}));u.some(f=>f._id==="head")?X.add(n):X.delete(n),r=Tr(u),i()},t);return()=>{a(),c()}}async function vr(n){const e=await gt($(n));if(e.empty)return;const t=Z(h);e.docs.forEach(s=>t.delete(s.ref)),await t.commit(),X.delete(n)}async function Er(n,e,t){const s=JSON.stringify(e),r=String(Date.now()),i=[];for(let o=0;o<s.length;o+=ht)i.push(s.slice(o,o+ht));const a=Z(h);i.forEach((o,u)=>a.set(d($(n),"p"+u),{part:u,of:i.length,rev:r,data:o})),(await gt($(n))).docs.forEach(o=>{if(o.id!=="head"&&!/^p\d+$/.test(o.id))return;(o.id==="head"?-1:Number(o.id.slice(1)))>=i.length&&a.delete(o.ref)}),a.set(d($(n),"head"),{of:i.length,rev:r,updatedAt:I(),_writer:t||""}),await a.commit(),X.add(n),await Me($e(n)).catch(()=>{})}async function hi(n,e,t){const s={...e,_writer:t||""};if(wr(JSON.stringify(s))<Ir)try{await m($e(n),{...s,updatedAt:I()}),X.has(n)&&await vr(n);return}catch(r){if(!yr(r))throw r}await Er(n,s,t)}async function fi(n,e){const t=await _(Pe()),r={...t.exists()?t.data().map||{}:{}};e?r[n]=e:delete r[n],await m(Pe(),{map:r,updatedAt:I()})}async function pi(n,e,t){if(!n)throw new Error("email required");await m(d(h,"budgetAccessRequests",n),{email:n,name:e||"",message:t||"",status:"pending",requestedAt:I()})}async function gi(n){if(!n)return null;const e=await _(d(h,"budgetAccessRequests",n));return e.exists()?e.data():null}function mi(n,e){return y(me(h,"budgetAccessRequests"),t=>{const s=[];t.forEach(r=>s.push({id:r.id,...r.data()})),n(s)},e)}async function _i(n,e){n&&(await _r(n,e||"viewer"),await m(d(h,"budgetAccessRequests",n),{email:n,status:"approved",approvedAt:I(),approvedAs:e||"viewer"},{merge:!0}))}async function Ii(n){n&&await m(d(h,"budgetAccessRequests",n),{email:n,status:"rejected",rejectedAt:I()},{merge:!0})}async function wi(){const n=await _(ye());if(!n.exists())return[];const e=n.data()||{};let t=null;try{t=JSON.parse(e.value||"{}")}catch{t={}}return Array.isArray(t.orgs)?t.orgs.map(s=>s.name).filter(Boolean):[]}export{C as ROLE,Ae as app,_i as approveAccessRequest,J as auth,Br as bDelete,Hr as bGet,qr as bSet,Gr as bSubscribe,Or as canManageRoles,Cr as canRead,Nr as canWrite,h as db,li as deleteSalesAttachment,Lr as detectCurrentWsId,zr as effectiveRole,Dr as ensureRoleAtFirstAccess,Fr as getBudgetOrgs,wi as getGlobalBudgetOrgs,Jr as getGlobalDataOnce,ni as getLoginUsers,gi as getMyAccessRequest,Ur as getMyRole,Mr as getWorkspace,br as handleRedirectResult,jr as isBootstrapAdmin,gr as isOwner,Ar as loginGoogle,Pr as logout,ti as recordLoginUser,Ii as rejectAccessRequest,Xr as setGlobalData,_r as setGlobalRole,fi as setGlobalUserCompany,Qr as setGlobalUserRole,si as setMenuConfig,Vr as setRole,ii as setSalesDoc,hi as setSalesMasters,xr as setUserCompany,pi as submitAccessRequest,mi as subscribeAccessRequests,Zr as subscribeGlobalCompanies,Kr as subscribeGlobalData,$r as subscribeGlobalRoles,ei as subscribeMenuConfig,ai as subscribeSalesColl,ri as subscribeSalesDoc,di as subscribeSalesMasters,Yr as subscribeUserRoles,Wr as subscribeWorkspace,Rr as watchAuth,ci as writeSalesAttachment,ui as writeSalesAttachmentChunked,oi as writeSalesItems};
