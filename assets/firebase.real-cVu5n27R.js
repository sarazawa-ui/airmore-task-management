import{r as ye,_ as jt,e as zt,d as _,g as q,q as J,E as Re,f as $t,h as Kt,L as Jt,j as it,S as X,k as Xt,F as Ae,l as Yt,i as at,m as Qt,n as Zt,c as qe,C as Ge,o as g,s as en,t as tn,u as nn,v as rn}from"./index.esm-B9iOFmxY.js";import{setDoc as v,doc as h,deleteDoc as ot,getDoc as E,onSnapshot as b,initializeFirestore as sn,persistentLocalCache as an,CACHE_SIZE_UNLIMITED as on,persistentMultipleTabManager as cn,getFirestore as un,updateDoc as Pe,collection as be,writeBatch as ln,serverTimestamp as C}from"./index.esm-C7w9jBNT.js";var dn="firebase",hn="12.16.0";/**
 * @license
 ...
 */ye(dn,hn,"app");function ct(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const fn=ct,ut=new Re("auth","Firebase",ct());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oe=new Jt("@firebase/auth");function pn(n,...e){oe.logLevel<=it.WARN&&oe.warn(`Auth (${X}): ${n}`,...e)}function re(n,...e){oe.logLevel<=it.ERROR&&oe.error(`Auth (${X}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Te(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function gn(){return Be()==="http:"||Be()==="https:"}function Be(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mn(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(gn()||Xt()||"connection"in navigator)?navigator.onLine:!0}function _n(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y{constructor(e,t){this.shortDelay=e,this.longDelay=t,P(t>e,"Short delay should be less than long delay!"),this.isMobile=$t()||Kt()}get(){return mn()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function En(n,e){return G(n,"POST","/v1/accounts:delete",e)}async function ce(n,e){return G(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function z(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof Ae&&Sn(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function Sn({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ue(n){var p;const e=n.auth,t=await n.getIdToken(),r=await z(n,ce(e,{idToken:t}));u(r==null?void 0:r.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const i=(p=s.providerUserInfo)!=null&&p.length?pt(s.providerUserInfo):[],a=Pn(n.providerData,i),o=n.isAnonymous,c=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),l=o?c:!1,d={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new ve(s.createdAt,s.lastLoginAt),isAnonymous:l};Object.assign(n,d)}async function An(n){const e=q(n);await ue(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Pn(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function pt(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bn(n,e){const t=await ht(n,{},async()=>{const r=J({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=n.config,a=await ft(n,s,"/v1/token",`key=${i}`),o=await n._getAdditionalHeaders();o["Content-Type"]="application/x-www-form-urlencoded";const c={method:"POST",headers:o,body:r};return n.emulatorConfig&&at(n.emulatorConfig.host)&&(c.credentials="include"),dt.fetch()(a,c)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function Cn(n,e){return G(n,"POST","/v2/accounts:revokeToken",Le(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mn(n,e={}){return G(n,"GET","/v2/passwordPolicy",Le(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let De={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function xn(n){De=n}function Vn(n){return De.loadJS(n)}function Wn(){return De.gapiScript}function Hn(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qn(n,e){const t=jt(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(zt(i,e??{}))return s;T(s,"already-initialized")}return t.initialize({options:e})}function Gn(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(R);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function W(n,e){return Tn(n,"POST","/v1/accounts:signInWithIdp",Le(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $n(n,e,t=!1){if(_(n.app))return Promise.reject(U(n));const r="signIn",s=await Rt(n,r,e),i=await H._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}function Kn(n,e,t,r){return q(n).onAuthStateChanged(e,t,r)}function Jn(n){return q(n).signOut()}const de="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt extends At{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}bt.type="SESSION";const Zn=bt;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ct(){return typeof y().WorkerGlobalScope<"u"&&typeof y().importScripts=="function"}async function rr(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function sr(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)==null?void 0:n.controller)||null}function ir(){return Ct()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ut{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:a,type:o}=e;if(a){this.reject(a);return}const c={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(o)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return hr;case"linkViaPopup":case"linkViaRedirect":return pr;case"reauthViaPopup":case"reauthViaRedirect":return fr;default:T(this.auth,"internal-error")}}resolve(e){P(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){P(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _r="pendingRedirect",ie=new Map;class Ir extends Ut{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=ie.get(this.auth._key());if(!e){try{const r=await wr(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}ie.set(this.auth._key(),e)}return this.bypassAuthState||ie.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function wr(n,e){const t=Ft(e),r=Dt(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}async function yr(n,e){return Dt(n)._set(Ft(e),"true")}function Tr(n,e){ie.set(n._key(),e)}function Dt(n){return R(n._redirectPersistence)}function Ft(n){return se(_r,n.config.apiKey,n.name)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vr(n,e,t){return Er(n,e,t)}async function Er(n,e,t){if(_(n.app))return Promise.reject(U(n));const r=Q(n);lt(n,e,fe),await r._initializationPromise;const s=xe(r,t);return await yr(s,r),s._openRedirect(r,e,"signInViaRedirect")}async function kr(n,e){return await Q(n)._initializationPromise,xt(n,e,!1)}async function xt(n,e,t=!1){if(_(n.app))return Promise.reject(U(n));const r=Q(n),s=xe(r,e),a=await new Ir(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sr=10*60*1e3;class Rr{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(r=>{this.isEventForConsumer(e,r)&&(t=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!Ar(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var r;if(e.error&&!Vt(e)){const s=((r=e.error.code)==null?void 0:r.split("auth/")[1])||"internal-error";t.onError(w(this.auth,s))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const r=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&r}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=Sr&&this.cachedEventUids.clear(),this.cachedEventUids.has(Ze(e))}saveEventToCache(e){this.cachedEventUids.add(Ze(e)),this.lastProcessedEventTime=Date.now()}}function Ze(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function Vt({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function Ar(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Vt(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pr(n,e={}){return G(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lr=new Y(3e4,6e4);function et(){const n=y().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Mr(n){return new Promise((e,t)=>{var s,i,a;function r(){et(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{et(),t(w(n,"network-request-failed"))},timeout:Lr.get()})}if((i=(s=y().gapi)==null?void 0:s.iframes)!=null&&i.Iframe)e(gapi.iframes.getContext());else if((a=y().gapi)!=null&&a.load)r();else{const o=Hn("iframefcb");return y()[o]=()=>{gapi.load?r():t(w(n,"network-request-failed"))},Vn(`${Wn()}?onload=${o}`).catch(c=>t(c))}}).catch(e=>{throw ae=null,e})}let ae=null;function Ur(n){return ae=ae||Mr(n),ae}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gr={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Br=500,jr=600,zr="_blank",$r="http://localhost";class tt{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Kr(n,e,t,r=Br,s=jr){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),a=Math.max((window.screen.availWidth-r)/2,0).toString();let o="";const c={...Gr,width:r.toString(),height:s.toString(),top:i,left:a},l=g().toLowerCase();t&&(o=It(l)?zr:t),mt(l)&&(e=e||$r,c.scrollbars="yes");const d=Object.entries(c).reduce((m,[te,B])=>`${m}${te}=${B},`,"");if(Nn(l)&&o!=="_self")return Jr(e||"",o),new tt(null);const p=window.open(e||"",o,d);u(p,n,"popup-blocked");try{p.focus()}catch{}return new tt(p)}function Jr(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const we="webStorageSupport";class es{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Zn,this._completeRedirectFn=xt,this._overrideRedirectResult=Tr}async _openPopup(e,t,r,s){var a;P((a=this.eventManagers[e._key()])==null?void 0:a.manager,"_initialize() not called before _openPopup()");const i=await nt(e,t,r,Te(),s);return Kr(e,i,Fe())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await nt(e,t,r,Te(),s);return nr(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(P(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await qr(e),r=new Rr(e);return t.register("authEvent",s=>(u(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(we,{type:we},s=>{var a;const i=(a=s==null?void 0:s[0])==null?void 0:a[we];i!==void 0&&t(!!i),T(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Nr(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Et()||_t()||Ue()}}const ts=es;var rt="@firebase/auth",st="1.13.3";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rs(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function ss(n){qe(new Ge("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:a,authDomain:o}=r.options;u(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const c={apiKey:a,authDomain:o,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:kt(n)},l=new Fn(r,s,i,c);return Gn(l,t),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),qe(new Ge("auth-internal",e=>{const t=Q(e.getProvider("auth").getImmediate());return(r=>new ns(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),ye(rt,st,rs(n)),ye(rt,st,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const is=5*60;Zt("authIdTokenMaxAge");function as(){var n;return((n=document.getElementsByTagName("head"))==null?void 0:n[0])??document}xn({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=s=>{const i=w("internal-error");i.customData=s,t(i)},r.type="text/javascript",r.charset="UTF-8",as().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});ss("Browser");const os={apiKey:"AIzaSyB8QE3JylXkXWmg_rF2ZuczixnRYJZlRnE",authDomain:"airmore-task-management-app.firebaseapp.com",projectId:"airmore-task-management-app",storageBucket:"airmore-task-management-app.firebasestorage.app",messagingSenderId:"674161520247",appId:"1:674161520247:web:fe0e0f9d0656008fbaa072",measurementId:"G-VFS9X3L72E"},Ee=rn(os),$=qn(Ee,{persistence:[dr,Qn],popupRedirectResolver:ts}),f=(()=>{try{return sn(Ee,{localCache:an({tabManager:cn(),cacheSizeBytes:on})})}catch(n){return console.warn("Firestore永続キャッシュの初期化に失敗。キャッシュ無しで継続します:",n&&n.message),un(Ee)}})();function fs(n){return Kn($,n)}async function ps(){const n=new k;n.setCustomParameters({prompt:"select_account"});try{return(await mr($,n)).user}catch(e){const t=e&&e.code||"";if(t==="auth/popup-blocked"||t==="auth/cancelled-popup-request"||t==="auth/popup-closed-by-user"||t==="auth/operation-not-supported-in-this-environment")return await vr($,n),null;throw e}}async function gs(){try{const n=await kr($);return(n==null?void 0:n.user)||null}catch(n){return console.warn("redirect result:",n),null}}async function ms(){await Jn($)}const A={ADMIN:"admin",EDITOR:"editor",VIEWER:"viewer"};function _s(n){return n===A.ADMIN||n===A.EDITOR||n===A.VIEWER}function Is(n){return n===A.ADMIN||n===A.EDITOR}function ws(n){return n===A.ADMIN}function ys(){try{const e=new URL(window.location.href).searchParams.get("ws");if(e)return localStorage.setItem("hittatsu_current_ws",e),e}catch{}return localStorage.getItem("hittatsu_current_ws")||null}async function Ts(n){if(!n)return null;const e=await E(h(f,"workspaces",n));return e.exists()?{id:e.id,...e.data()}:null}function vs(n,e){return!n||!e?null:(n.budgetRoles||{})[e]||null}function cs(n,e){if(!n||!e)return!1;const t=(n.authMembers||[]).find(r=>r&&r.email===e);return t&&t.role==="owner"}async function Es(n,e,t){if(!n||!e||!t)return null;const r=(t.budgetRoles||{})[e];if(r)return r;const s=cs(t,e)?A.ADMIN:A.VIEWER;try{const i={...t.budgetRoles||{},[e]:s};return await Pe(h(f,"workspaces",n),{budgetRoles:i}),s}catch(i){return console.warn("ensureRoleAtFirstAccess failed:",i),null}}async function ks(n,e,t){if(!n||!e)return!1;const r=await E(h(f,"workspaces",n));if(!r.exists())return!1;const i={...r.data().userCompanies||{}};return t?i[e]=t:delete i[e],await Pe(h(f,"workspaces",n),{userCompanies:i}),!0}async function Ss(n){if(!n)return[];try{const e=await E(h(f,"workspaces",n,"budget","airmore-budget-v4"));if(!e.exists())return[];const t=e.data()||{};let r=null;try{r=JSON.parse(t.value||"{}")}catch{r={}}return Array.isArray(r.orgs)?r.orgs.map(s=>s.name).filter(Boolean):[]}catch(e){return console.warn("getBudgetOrgs failed:",e),[]}}async function Rs(n,e,t){if(!n||!e)return!1;const r=await E(h(f,"workspaces",n));if(!r.exists())return!1;const i={...r.data().budgetRoles||{}};return t?i[e]=t:delete i[e],await Pe(h(f,"workspaces",n),{budgetRoles:i}),!0}function As(n,e){return b(h(f,"workspaces",n),t=>{t.exists()?e({id:t.id,...t.data()}):e(null)})}const us=n=>be(f,"workspaces",n,"budget");async function Ps(n,e){const t=await E(h(f,"workspaces",n,"budget",We(e)));return t.exists()?(t.data()||{}).value??null:null}async function bs(n,e,t){await v(h(f,"workspaces",n,"budget",We(e)),{key:e,value:t,updatedAt:C()})}async function Cs(n,e){await ot(h(f,"workspaces",n,"budget",We(e)))}function Ns(n,e){return b(us(n),t=>{const r={};t.forEach(s=>{const i=s.data();r[i.key||s.id]=i.value}),e(r)})}function We(n){return String(n).replace(/[/.#$\[\]]/g,"_").slice(0,250)}const Wt=new Set(["sarazawa@n-airmore.com"]);function Os(n){return!!n&&Wt.has(n)}function Ls(n,e){return n?Wt.has(n)?A.ADMIN:(e||{})[n]||null:null}const ke=()=>h(f,"globalBudget","roles"),me=()=>h(f,"globalBudget","data"),Se=()=>h(f,"globalBudget","userCompanies");function Ms(n,e){return b(ke(),t=>{n(t.exists()?t.data().roles||{}:{})},e)}async function ls(n,e){const t=await E(ke()),s={...t.exists()?t.data().roles||{}:{}};e?s[n]=e:delete s[n],await v(ke(),{roles:s,updatedAt:C()})}function Us(n,e){return b(me(),n,e)}async function Ds(){const n=await E(me());return n.exists()?n.data():null}async function Fs(n,e){await v(me(),{value:n,updatedAt:C(),_writer:e})}function xs(n,e){return b(Se(),t=>{n(t.exists()?t.data().map||{}:{})},e)}const Ht=n=>h(f,"salesWs",n),K=(n,e)=>be(f,"salesWs",n,e);function Vs(n,e,t){return b(Ht(n),r=>e(r.exists()?r.data():null),t)}async function Ws(n,e){await v(Ht(n),{...e,updatedAt:C()},{merge:!0})}function Hs(n,e,t,r){return b(K(n,e),s=>t(s.docs.map(i=>i.data())),r)}async function qs(n,e,t,r){const s=[...t.map(i=>({kind:"set",it:i})),...(r||[]).map(i=>({kind:"del",id:i}))];for(let i=0;i<s.length;i+=400){const a=ln(f);for(const o of s.slice(i,i+400))o.kind==="set"?a.set(h(K(n,e),o.it.id),o.it):a.delete(h(K(n,e),o.id));await a.commit()}}async function Gs(n,e){await v(h(K(n,"attachments"),e.id),e)}async function Bs(n,e){await ot(h(K(n,"attachments"),e))}const qt=n=>h(f,"salesMasters",n);function js(n,e,t){return b(qt(n),r=>{e(r.exists()?r.data():null)},t)}async function zs(n,e,t){await v(qt(n),{...e,updatedAt:C(),_writer:t||""})}async function $s(n,e){const t=await E(Se()),s={...t.exists()?t.data().map||{}:{}};e?s[n]=e:delete s[n],await v(Se(),{map:s,updatedAt:C()})}async function Ks(n,e,t){if(!n)throw new Error("email required");await v(h(f,"budgetAccessRequests",n),{email:n,name:e||"",message:t||"",status:"pending",requestedAt:C()})}async function Js(n){if(!n)return null;const e=await E(h(f,"budgetAccessRequests",n));return e.exists()?e.data():null}function Xs(n,e){return b(be(f,"budgetAccessRequests"),t=>{const r=[];t.forEach(s=>r.push({id:s.id,...s.data()})),n(r)},e)}async function Ys(n,e){n&&(await ls(n,e||"viewer"),await v(h(f,"budgetAccessRequests",n),{email:n,status:"approved",approvedAt:C(),approvedAs:e||"viewer"},{merge:!0}))}async function Qs(n){n&&await v(h(f,"budgetAccessRequests",n),{email:n,status:"rejected",rejectedAt:C()},{merge:!0})}async function Zs(){const n=await E(me());if(!n.exists())return[];const e=n.data()||{};let t=null;try{t=JSON.parse(e.value||"{}")}catch{t={}}return Array.isArray(t.orgs)?t.orgs.map(r=>r.name).filter(Boolean):[]}export{A as ROLE,Ee as app,Ys as approveAccessRequest,$ as auth,Cs as bDelete,Ps as bGet,bs as bSet,Ns as bSubscribe,ws as canManageRoles,_s as canRead,Is as canWrite,f as db,Bs as deleteSalesAttachment,ys as detectCurrentWsId,Ls as effectiveRole,Es as ensureRoleAtFirstAccess,Ss as getBudgetOrgs,Zs as getGlobalBudgetOrgs,Ds as getGlobalDataOnce,Js as getMyAccessRequest,vs as getMyRole,Ts as getWorkspace,gs as handleRedirectResult,Os as isBootstrapAdmin,cs as isOwner,ps as loginGoogle,ms as logout,Qs as rejectAccessRequest,Fs as setGlobalData,ls as setGlobalRole,$s as setGlobalUserCompany,Rs as setRole,Ws as setSalesDoc,zs as setSalesMasters,ks as setUserCompany,Ks as submitAccessRequest,Xs as subscribeAccessRequests,xs as subscribeGlobalCompanies,Us as subscribeGlobalData,Ms as subscribeGlobalRoles,Hs as subscribeSalesColl,Vs as subscribeSalesDoc,js as subscribeSalesMasters,As as subscribeWorkspace,fs as watchAuth,Gs as writeSalesAttachment,qs as writeSalesItems};
